...
const MenuConnecter = (props) => {
  
        return (
            <div className="header">
                    <div className="Logo">
                        <div className="lesLogos"><Link to="./MonApp"><p className="logo1">immo<strong className="logo2">af.com</strong></p></Link></div>
                          <p className="utilisateurConnecter">Vous êtes connectés en tant que: <strong className="utilisateurConnecterps">{props.userData.pseudo}</strong> </p>
                        <Logout />
